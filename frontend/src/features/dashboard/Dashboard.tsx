    ...
    >
      ...
      <main className="flex-1 min-w-0 px-4 md:px-8 py-6 md:py-8 mb-20">
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm" style={{ color: BRAND.inkSoft }}>
              Your sales and expenses, all in one place.
            </p>
          </div>
          <AddMenu
        ...
        <div className="mt-6">
          ...
          <OverviewFilters
            type={overview.type}
            onTypeChange={overview.setType}
            range={overview.range}
            onRangeChange={overview.setRange}
            dateFrom={overview.dateFrom}
            dateTo={overview.dateTo}
            onDateFromChange={overview.setDateFrom}
            onDateToChange={overview.setDateTo}
            sort={overview.sort}
          ...
          {overview.isLoading ? (
            ...
            <>
              ...
              <Pagination
                ...
                onPageChange={overview.goToPage}
              />
            </>
          )}
        </div>
